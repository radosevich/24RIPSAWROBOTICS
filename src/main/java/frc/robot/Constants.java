...
public final class Constants {
    ...
    public static final double kHighIntakeSpeed = -.75; // Update this with your desired intake speed
    public static final double kLowIntakeSpeed = .75; // Did it thanks bro
    // Shooter
